...
var calc = function calc(size, material, options, promoCode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value === '' || materialBlock.value === '') {
      resultBlock.textContent = 'Выберите и размер и материал картины';
    } else if (promoBlock.value === 'POPART') {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        ...
        document.body.style.overflow = 'hidden';
        var scroll = calcSideScroll();
        document.body.style.marginRight = "".concat(scroll, "px");
      }
    }, time);
  }

  function calcSideScroll() {
  ...
  links.forEach(function (link) {
    return link.addEventListener('click', function (e) {
      ...
      var widthTop = document.documentElement.scrollTop,
          // сколько прокрутили пикселей
      hash = this.hash,
          // то что записано в href
      toBlock = document.querySelector(hash).getBoundingClientRect().top,
          // сколько пикселей до элемента к которому будем скролить
      start = null;
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    var wrapper = document.querySelector('#styles .row');
  ...
  } // Обращаемся к серверу где хранится файл json
  // btn.addEventListener('click', () => {
  ...
  //     .finally(() => btn.remove())
  // })
  // Обращаемся напрямую к файлу json
...
var sliders = function sliders(slides, direction, prev, next) {
  ...
  function addAnimationToSlides(rmClass, addClass) {
    items[slideIndex].classList.remove(rmClass);
    items[slideIndex].classList.add(addClass);
  }
  ...
  try {
    ...
    prevBtn.addEventListener('click', function () {
      plusSlides(-1);
      addAnimationToSlides('slideInLeft', 'slideInRight');
    });
    nextBtn.addEventListener('click', function () {
      plusSlides(1);
      addAnimationToSlides('slideInRight', 'slideInLeft');
    });
  } catch (e) {}
  ...
  activateAnimation();
  items[0].parentElement.addEventListener('mouseleave', activateAnimation);
  items[0].parentElement.addEventListener('mouseover', function () {
